...
void Cube::pretty_print()
{
	...
	cout << "                   / \\   " << container[5].get_matrix(0, 0) << "	  " << container[5].get_matrix(0, 1) << "		" << container[5].get_matrix(0, 2) << "    \\             " << endl;
	cout << "                  /   \\  	              \\            " << endl;
	cout << "                 /  " << container[1].get_matrix(0, 2) << "  \\   " << container[5].get_matrix(1, 0) << "     " << container[5].get_matrix(1, 2) << "     " << container[5].get_matrix(2, 1) << "   \\           " << endl;
	cout << "                /       \\				    \\          " << endl;
	cout << "               / " << container[1].get_matrix(0, 1) << "	  " << container[1].get_matrix(1, 2) << "  \\   " << container[5].get_matrix(2, 0) << "    " << container[5].get_matrix(2, 1) << "      " << container[5].get_matrix(2, 2) << "   \\         " << endl;
	cout << "			  /		      \\___________________\\        " << endl;
...
void Cube::RotateSide(unsigned int side, bool cw)
{
	...
	if (cw)
	{
		...
		tmp1[0] = this->container[side].get_matrix(0, 0);
		tmp1[1] = this->container[side].get_matrix(0, 1);
		tmp1[2] = this->container[side].get_matrix(0, 2);

		tmp2[0] = this->container[side].get_matrix(1, 0);
		tmp2[1] = this->container[side].get_matrix(1, 1);
		tmp2[2] = this->container[side].get_matrix(1, 2);

		tmp3[0] = this->container[side].get_matrix(2, 0);
		tmp3[1] = this->container[side].get_matrix(2, 1);
		tmp3[2] = this->container[side].get_matrix(2, 2);

		this->container[side].set_matrix(0, 2, tmp1[0]);
		this->container[side].set_matrix(1, 2, tmp1[1]);
		this->container[side].set_matrix(2, 2, tmp1[2]);

		this->container[side].set_matrix(0, 1, tmp2[0]);
		this->container[side].set_matrix(1, 1, tmp2[1]);
		this->container[side].set_matrix(2, 1, tmp2[2]);

		this->container[side].set_matrix(0, 0, tmp3[0]);
		this->container[side].set_matrix(1, 0, tmp3[1]);
		this->container[side].set_matrix(2, 0, tmp3[2]);
		...
		*/
		...
		if (side == 0)
		{
			...
			this->container[3].set_matrix(0, 2, tmp4_1);
			this->container[3].set_matrix(0, 1, tmp4_2);
			this->container[3].set_matrix(0, 0, tmp4_3);
		...
		if (side == 1)
		{
			...
			this->container[2].set_matrix(0, 0, tmp5_1);
			this->container[2].set_matrix(1, 0, tmp5_2);
			this->container[2].set_matrix(2, 0, tmp5_3);

			this->container[0].set_matrix(0, 0, tmp2_1);
			this->container[0].set_matrix(1, 0, tmp2_2);
			this->container[0].set_matrix(2, 0, tmp2_3);

			this->container[3].set_matrix(0, 0, tmp0_1);
			this->container[3].set_matrix(1, 0, tmp0_2);
			this->container[3].set_matrix(2, 0, tmp0_3);

			this->container[5].set_matrix(2, 2, tmp3_1);
			this->container[5].set_matrix(1, 2, tmp3_2);
			this->container[5].set_matrix(0, 2, tmp3_3);
		...
		if (side == 2)
		{
			...
			this->container[1].set_matrix(0, 2, tmp0_1);
			this->container[1].set_matrix(0, 1, tmp0_2);
			this->container[1].set_matrix(0, 0, tmp0_3);
			...
			this->container[0].set_matrix(0, 2, tmp4_1);
			this->container[0].set_matrix(0, 1, tmp4_2);
			this->container[0].set_matrix(0, 0, tmp4_3);
		...
		if (side == 3)
		{
			...
			this->container[0].set_matrix(2, 2, tmp1_1);
			this->container[0].set_matrix(2, 1, tmp1_2);
			this->container[0].set_matrix(2, 0, tmp1_3);

			this->container[4].set_matrix(2, 2, tmp0_1);
			this->container[4].set_matrix(2, 1, tmp0_2);
			this->container[4].set_matrix(2, 0, tmp0_3);

			this->container[5].set_matrix(2, 2, tmp4_1);
			this->container[5].set_matrix(2, 1, tmp4_2);
		...
		if (side == 4)
		{
			...
			this->container[0].set_matrix(2, 2, tmp3_1);
			this->container[0].set_matrix(1, 2, tmp3_2);
			this->container[0].set_matrix(0, 2, tmp3_3);

			this->container[2].set_matrix(2, 2, tmp0_1);
			this->container[2].set_matrix(1, 2, tmp0_2);
			this->container[2].set_matrix(0, 2, tmp0_3);

			this->container[5].set_matrix(0, 0, tmp2_1);
			this->container[5].set_matrix(1, 0, tmp2_2);
			this->container[5].set_matrix(2, 0, tmp2_3);
		...
		if (side == 5)
		{
			...
			this->container[2].set_matrix(0, 0, tmp1_1);
			this->container[2].set_matrix(0, 1, tmp1_2);
			this->container[2].set_matrix(0, 2, tmp1_3);

			this->container[4].set_matrix(0, 2, tmp2_1);
			this->container[4].set_matrix(1, 2, tmp2_2);
			this->container[4].set_matrix(2, 2, tmp2_3);

			this->container[3].set_matrix(2, 2, tmp4_1);
			this->container[3].set_matrix(2, 1, tmp4_2);
			this->container[3].set_matrix(2, 0, tmp4_3);

			this->container[1].set_matrix(2, 0, tmp3_1);
			this->container[1].set_matrix(1, 0, tmp3_2);
			this->container[1].set_matrix(0, 0, tmp3_3);
	...
	else
	{
		...
		*/
		...
		this->container[side].set_matrix(0, 0, tmp1[2]);
		this->container[side].set_matrix(1, 0, tmp1[1]);
		this->container[side].set_matrix(2, 0, tmp1[0]);

		this->container[side].set_matrix(0, 1, tmp2[2]);
		this->container[side].set_matrix(1, 1, tmp2[1]);
		this->container[side].set_matrix(2, 1, tmp2[0]);

		this->container[side].set_matrix(0, 2, tmp3[2]);
		this->container[side].set_matrix(1, 2, tmp3[1]);
		this->container[side].set_matrix(2, 2, tmp3[0]);
		//}
